...
import time
#dataset description: https://www.kaggle.com/vermaavi/food11
data_path= 'C:/data/kaggle/input/NTU/lecture3/food-11'
train_path= data_path+'/training'
validate_path= data_path+'/validation'
test_path= data_path+'testing'



def readfile(path, label):
    # label is bool => testing or training data 
...
#use DataLoader in torch.utils.data to preprocess data
